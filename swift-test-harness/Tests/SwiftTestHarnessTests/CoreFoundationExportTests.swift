...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `CoreFoundation.swiftmodule/`
...
//      `import CoreFoundation` above would fail at compile time.
//
//   2. The static archive `libCoreFoundation.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "CoreFoundation" }` and
//      `flattenPackage = "io.github.kotlinmania.corefoundation"` configuration in
...
//      via the `CoreFoundationLibrary` product.
//
...
final class CoreFoundationExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "CoreFoundation swift module imported cleanly")
    }
}
