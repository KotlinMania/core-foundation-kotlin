...
Kotlin Multiplatform line-by-line clean-room port of the Rust crate [`core-foundation`](https://crates.io/crates/core-foundation).

> **Status: scaffold — porting has not started.** This repo currently contains build infrastructure only. The upstream Rust source for the `core-foundation` crate will be cloned into `tmp/` (gitignored) when porting begins.

## About

Bindings to the macOS Core Foundation framework
...
Original work copyrighted by the upstream `core-foundation` authors. Kotlin port copyright (c) 2026 Sydney Renee and The Solace Project.
