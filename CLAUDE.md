# Claude Code Project Instructions — core-foundation-kotlin

## Project Overview

This is **core-foundation-kotlin**, a clean-room Kotlin Multiplatform port of the upstream Rust crate [`core-foundation`](https://crates.io/crates/core-foundation).

The upstream Rust source is the read-only translation oracle. When porting begins, clone it into `tmp/core-foundation/` (gitignored). **Never edit `tmp/`.** If upstream looks wrong, the bug is in the port or in your understanding of Rust, not in `tmp/`.
...
```kotlin
// port-lint: source <path-relative-to-tmp/core-foundation>
