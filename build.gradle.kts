...
kotlin {
    ...
    swiftExport {
        ...
        flattenPackage = "io.github.kotlinmania.corefoundation"
    }

    android {
        namespace = "io.github.kotlinmania.corefoundation"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "core-foundation-kotlin", version.toString())

    pom {
        name.set("core-foundation-kotlin")
        description.set("Kotlin Multiplatform port of servo/core-foundation-rs - Bindings to Core Foundation for macOS")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/core-foundation-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/core-foundation-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/core-foundation-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/core-foundation-kotlin.git")
        }
    }
}
...
// kotlinc-compiled commonMain sources through the CodeQL Java agent. This repo
// keeps its real CoreFoundation implementation in native source sets, so the
// task emits a generated sentinel until commonMain code exists.
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve(
                "io/github/kotlinmania/corefoundation/CodeqlEmptySentinel.kt",
            )
            ...
            sentinelFile.writeText(
                ...
                // commonMain content once the repo has portable source.
                package io.github.kotlinmania.corefoundation
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleCoreFoundationXCFramework",
    "assembleCoreFoundationDebugXCFramework",
    "assembleCoreFoundationReleaseXCFramework",
    "assembleDebugIosFatFrameworkForCoreFoundationXCFramework",
    "assembleReleaseIosFatFrameworkForCoreFoundationXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForCoreFoundationXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForCoreFoundationXCFramework",
    "assembleDebugMacosFatFrameworkForCoreFoundationXCFramework",
    "assembleReleaseMacosFatFrameworkForCoreFoundationXCFramework",
    "assembleDebugTvosFatFrameworkForCoreFoundationXCFramework",
    "assembleReleaseTvosFatFrameworkForCoreFoundationXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForCoreFoundationXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForCoreFoundationXCFramework",
    "assembleDebugWatchosFatFrameworkForCoreFoundationXCFramework",
    "assembleReleaseWatchosFatFrameworkForCoreFoundationXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForCoreFoundationXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForCoreFoundationXCFramework",
