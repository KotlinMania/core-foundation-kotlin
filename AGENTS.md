...
This file is the quick-reference operating contract for core-foundation-kotlin. The longer
...
core-foundation-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`core-foundation`](https://crates.io/crates/core-foundation). Upstream Rust is the behavioral oracle while the
