...
class CFString internal constructor(private val ref: CFStringRef) : TCFType<CFStringRef> {
    ...
    override fun toString(): String {
        ...
        memScoped {
            ...
            require(bytesRequired.value in 1..Int.MAX_VALUE) { "CFString too large to convert to Kotlin String" }

            val buffer = ByteArray(bytesRequired.value)
            buffer.usePinned { pinned ->
                ...
                require(bytesUsed.value == buffer.size) { "Unexpected bytes used" }
            }
